...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # MacOSで開発の場合は明示的にNFSとすることを推奨
  #config.vm.synced_folder ".", "/vagrant", type:"nfs", owner: "apache", group:"apache", mount_options: ["dmode=755", "fmode=777"]
  ...
  # the file centos67.pp in the manifests_path directory.
  #
